...
In other words, it's a **snapshotting tool for databases**.
It can also capture the state of multiple databases ([subdots](https://docs.dotmesh.com/concepts/what-is-a-datadot/#subdots)) in a single atomic commit.
