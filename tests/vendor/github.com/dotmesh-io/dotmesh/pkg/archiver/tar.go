// package archive is heavily inspired by https://github.com/mholt/archiver/blob/master/tar.go (License MIT)
// just with an addition to archive directly to a given writer and removal of unused
// functionality
package archiver
